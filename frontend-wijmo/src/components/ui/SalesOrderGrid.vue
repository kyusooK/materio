<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','salesPerson','companyId','status','salesItems','salesType',]" />
            ...
            <wj-flex-grid-column binding="companyId" header="회사" width="2*" :isReadOnly="true" align="center">
                <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">   
                    <CompanyId v-model="cell.item.companyId" :editMode="editMode"></CompanyId>
